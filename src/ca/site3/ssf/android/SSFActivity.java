...
public class SSFActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bar.addTab(bar.newTab().setText(R.string.tab_arena)
				.setTabListener(new TabListener(arenaDisplayFragment, "Arena")));
		bar.addTab(bar.newTab().setText(R.string.tab_text)
	...
	public void onResume() {
		...
		filter.addAction(Intents.EVENT_PLAYER_ACTION_POINTS_CHANGED);
		...
		((SSFApplication) getApplication()).startTimeout();
	}
	...
	private BroadcastReceiver askForRefresh = new BroadcastReceiver() {
		@Override
	...
	private BroadcastReceiver onGameEvent = new BroadcastReceiver() {
		@Override
		public void onReceive(Context context, Intent intent) {
			arenaDisplayFragment.handleGameModelEvent((IGameModelEvent) intent
					.getExtras().get(Intents.EXTRA_EVENT));
		}
	};
	...
	public void setConnectionStatus(boolean connected) {
		if (connectionStatusView != null) {
			connectionStatusView.findViewById(R.id.connection_status_color)
					.setBackgroundColor(
							getResources().getColor(
									connected ? R.color.status_connected
											: R.color.status_disconnected));
			((TextView) connectionStatusView
					.findViewById(R.id.connection_status_text))
					.setText(connected ? R.string.status_connected
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		connectionStatusView = menu.findItem(R.id.connection_status)
				.getActionView();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.refresh:
			sendBroadcast(new Intent(Intents.REFRESH));
			return true;
		case R.id.test_system:
			sendBroadcast(new Intent(Intents.TEST_SYSTEM));
			return true;
		default:
